...
import RescheduledDay from "../pages/rescheduledDay.page";
import AfterAll from "../pages/afterAll.page";
...
test.describe.serial("SmokeTest", () => {
  ...
  let rescheduledDay: RescheduledDay;
  let afterAllPage: AfterAll;
  let page;
  ...
  test.beforeAll(async ({ browser, baseURL }) => {
    ...
    rescheduledDay = new RescheduledDay(page);
    afterAllPage = new AfterAll(page);
  ...
  test.afterAll(async () => {
    ...
    await afterAllPage.openAppointment();
    await afterAllPage.deleteAppointment();
